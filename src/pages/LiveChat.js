...
const LiveChat = () => {
  ...
  const [roomWithNewChat, setRoomWithNewChat] = useState();
  ...
  return (
    <div className="container-fluid mb-0 px-4" id={styles["chat-box"]}>
      <div id={styles["livechat-header"]}>
        <div className="fs-4 fw-bold">Chat</div>
      ...
      {adminUser ? (
        ...
        >
          <div className="col col-3 border-end d-flex flex-column align-items-center p-0 h-100">
            {/* Search input */}
            <input
              type="text"
            ...
            {/* Chat room lists */}
            <div
              className={`d-flex flex-column h-100 overflow-auto ${styles["room-list"]}`}
            >
              {roomList &&
                roomList.length > 0 &&
                roomList.map((roomId) => {
                  ...
                  const newChat =
                    roomWithNewChat === roomId &&
                    roomWithNewChat !== curRoom.roomId
                      ? " text-danger"
                      : undefined;
                  return (
                    <div
                      ...
                      className={
                        roomId === curRoom?.roomId
                          ? styles["room-active"] + " " + classes + newChat
                          : classes + newChat
                      }
